...
use GPLSCore\GPLS_PLUGIN_WADVCPA\Settings\SettingsFields\TextAreaField;
use GPLSCore\GPLS_PLUGIN_WADVCPA\Settings\SettingsFields\TextField;
use GPLSCore\GPLS_PLUGIN_WADVCPA\Settings\SettingsFields\RepeaterField;
use GPLSCore\GPLS_PLUGIN_WADVCPA\Settings\SettingsFields\SelectField;
use GPLSCore\GPLS_PLUGIN_WADVCPA\Settings\SettingsFields\RadioField;
use GPLSCore\GPLS_PLUGIN_WADVCPA\Settings\SettingsFields\CheckboxField;
use GPLSCore\GPLS_PLUGIN_WADVCPA\Settings\SettingsFields\NumberField;
...
class Field extends Base {
	...
	public static function print_field( $field, $full_field = true, $echo = true, $ignore_hide = true ) {
		$id    = ! empty( $field['base_id'] ) ? $field['base_id'] : self::$plugin_info['name'];
	...
	public static function print_fields( $fields, $full_field = true, $echo = true, $ignore_hide = true ) {
		$id = ! empty( $fields['base_id'] ) ? $fields['base_id'] : self::$plugin_info['name'];
		?>
